      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              <h2 class="ftco-heading-2 logo">AXS Internet Banda Ancha</h2>
              <?php
          ...
          <div class="col-md" style="padding-left: 150px">
            <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="about.php" class="py-2 d-block">Servicios de Internet</a></li>
                <li><a href="services.php" class="py-2 d-block">Servicio Tecnico</a></li>
                <li><a href="contact.php" class="py-2 d-block">Puntos de Pago</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md">
        ...
        <div class="row">
          <div class="col-md-12 text-center ">
            ...
            <p>
  2022 &copy AXS Internet Banda Ancha </p>
          </div>
        </div>
      </div>
</footer>
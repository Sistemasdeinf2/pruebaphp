...
(1, 'aboutus', 'Acerca de', '                                Somos el mejor SALON del mundo, porque usamos la mejor aplicacion, nuestra vida es mas facil y todo es mas sencillo de controlar desde que tenemos la app de configuroweb, SPA ConfiguroWeb.', NULL, NULL, NULL, ''),
(2, 'contactus', 'Contacto', '                                        Santa Cruz-BOLIVIA', 'SALON_SyT@gmail.com', 573162430081, NULL, '08:00 am to 6:30 pm');
